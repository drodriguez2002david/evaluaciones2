                ...
                <div class="modal-header">
                  <h5 class="modal-title">
                    {{ selectedActivity && selectedActivity.enigmaNumber === 1 ? 'ENIGMA 1: ¿Por qué los mares no crecen sin parar? ¿Por qué los ríos no se vacían?' :
                       ...
                       selectedActivity && selectedActivity.type === 'explica' && getCellType(selectedActivity.index - 1) === 'explica' && selectedActivity.index % 10 === 3 ? 'Explica el alumno 1: ¿Por qué los mares no se desbordan?' :
