                ...
                <div class="modal-header">
                  <h5 class="modal-title">
                    {{ selectedActivity && selectedActivity.enigmaNumber === 1 ? 'ENIGMA 1: ¿Por qué los mares no crecen sin parar? ¿Por qué los ríos no se vacían?' :
                       ...
                       selectedActivity && selectedActivity.type === 'explica' && selectedActivity.index === 3 || (selectedActivity && selectedActivity.type === 'explica' && selectedActivity.index === 13) ? 'Explica el alumno 1: ¿Por qué los mares no se desbordan?' : 'Evaluación' }}
                  </h5>
