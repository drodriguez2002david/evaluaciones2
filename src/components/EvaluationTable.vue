                ...
                <div class="modal-header">
                  <h5 class="modal-title">
                    {{ selectedActivity && selectedActivity.enigmaNumber === 1 ? 'ENIGMA 1: ¿Por qué los mares no crecen sin parar? ¿Por qué los ríos no se vacían?' :
                       ...
                       selectedActivity && selectedActivity.type === 'explica' && [3, 13, 23, 33, 43, 53, 63, 73, 83, 93].includes(selectedActivity.index) ? 'Explica el alumno 1: ¿Por qué los mares no se desbordan?' :
