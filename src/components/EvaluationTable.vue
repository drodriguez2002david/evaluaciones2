                ...
                <div class="modal-header">
                  <h5 class="modal-title">
                    {{ selectedActivity && selectedActivity.enigmaNumber === 1 ? 'ENIGMA 1: ¿Por qué los mares no crecen sin parar? ¿Por qué los ríos no se vacían?' :
                       ...
                       selectedActivity && selectedActivity.index === 3 ? 'Explica el alumno 1: ¿Por qué los mares no se desbordan?' :
                       selectedActivity && selectedActivity.index === 13 ? 'Explica el alumno 1: ¿Por qué los mares no se desbordan?' :
                       selectedActivity && selectedActivity.index === 4 ? 'Explica el alumno 2: ¿Por qué el mar es salado?' : 'Evaluación' }}
                  </h5>
